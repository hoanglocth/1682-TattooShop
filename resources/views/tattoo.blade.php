                            ...
                            <div id="comment-section" class="collapse">
                                <div class="row">
                                    ...
                                    <div class="col-9">
                                        ...
                                        <input type="label" value="{{ $tattoo->id }}" name="tattoo_id" id="tattoo_id"
                                            style="display: none;">
                                        <input type="label" value="{{ Auth::user()->id }}" name="user_id"
                                            id="book-id" style="display: none;">
                                        <input type="label" value="{{ $user_rating ? $user_rating->id : null }}"
                                            name="rating_id" id="book-id" style="display: none;">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-11 comment">
                                            <div style="width: 100%" class="mt-2">
                                                <p style="font-weight: bold">{{ $rating->user->firstname }}</p> Commented
